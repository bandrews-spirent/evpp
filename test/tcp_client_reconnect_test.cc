...
TEST_UNIT(testTCPClientReconnect) {
    ...
    for (int i = 0; i < test_count; i++) {
        EVPP_LOG_INFO << "NNNNNNNNNNNNNNNN TestTCPClientReconnect i=" << i;
    ...
    EVPP_LOG_INFO << "XXXXXXXXXX connected_count=" << connected_count << " message_recved_count=" << message_recved_count;
